import { ATSType, JobSite } from "@/types";
...
export const getATSType = (site: JobSite): ATSType | undefined => site.atsType ?? detectATS(site.url);
...
export const getATSInitials = (atsType: ATSType | undefined): string =>
    getATSInfo(atsType)?.initials ?? (atsType ? atsType.substring(0, 2).toUpperCase() : "");