// /src/components/add-application-dialog/AddApplicationDialog.test.ts
...
import type { Props as AddApplicationDialogProps } from "@/components/add-application-dialog";
